<%-- 
    Document   : staff2
    Created on : Oct 7, 2022, 5:26:34 PM
    Author     : DESHANI
--%>
...
<html>
    ...
    <center>
       ...
       <div class="content"><h3><a href="viewFlight.jsp" style="text-decoration: none; color: #ffffff; font-weight: bold">View Flight Details</a></h3>
